...
const PostCard = ({ post }) => {
  return (
    <div className="group relative h-[330px] w-full border border-teal-500 hover:border-2 overflow-hidden rounded-lg sm:w-[430px] transition-all shadow-md shadow-teal-500">
